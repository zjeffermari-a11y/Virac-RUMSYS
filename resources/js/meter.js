        ...
        setupEventListeners() {
            ...
            if (updateContactNumberBtn && contactNumberInput) {
                ...
                updateContactNumberBtn.addEventListener("click", async () => {
                    ...
                    if (!contactNumber) {
                        this.methods.showNotification("Please enter a contact number", "error");
                        return;
                    }

                    if (!/^09\d{9}$/.test(contactNumber)) {
                        this.methods.showNotification("Contact number must be 11 digits starting with 09", "error");
                        return;
                    }
                    ...
                    try {
                        ...
                        if (response.ok) {
                            this.methods.showNotification(result.message || "Contact number updated successfully!", "success");
                        } else {
