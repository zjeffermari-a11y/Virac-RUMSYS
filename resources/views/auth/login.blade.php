        ...
        <div class="bg-white shadow-soft overflow-hidden flex flex-col lg:flex-row w-full h-full rounded-2xl corner-border relative">
            ...
            <div class="lg:w-2/5 px-6 pt-6 pb-6 lg:px-8 lg:pt-8 lg:pb-8 xl:px-10 xl:pt-10 flex flex-col justify-center max-w-md mx-auto lg:max-w-none h-full overflow-y-auto relative">
                ...
                <div class="absolute top-5 right-5 lg:top-6 lg:right-6 xl:top-8 xl:right-8">
                    <img src="{{ asset('images/logo.png') }}" alt="Virac RUMSYS Logo" width="64" height="64" class="h-12 lg:h-16 w-auto">
                </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <button type="button" id="togglePassword"
                                    ...
                                    class="absolute inset-y-0 right-0 pr-3 flex items-center focus:outline-none focus-visible:ring-2 focus-visible:ring-yellow-400 rounded">
                                    <i class="fas fa-eye text-gray-400 cursor-pointer hover:text-gray-600 text-sm" id="eyeIcon" aria-hidden="true"></i>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm">
                                ...
                                @if ($errors->has('username'))
                                    <p class="text-sm text-red-600 mt-1.5 flex items-center gap-1.5" role="alert">
