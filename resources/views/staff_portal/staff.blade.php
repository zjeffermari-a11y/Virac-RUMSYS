...
@section('content')
    ...
    <div id="homeSection" class="dashboard-section">
        ...
        <div class="bg-white dark:bg-dark-surface p-4 md:p-8 rounded-2xl shadow-lg dark:shadow-none dark:border dark:border-dark-border/30 transition-colors duration-300">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
                <h3 class="text-lg md:text-xl font-bold text-gray-800 dark:text-gray-100 flex items-center gap-2">
                    <i class="fas fa-list-ul text-market-primary"></i>
                    Pending Tasks
                </h3>
            </div>

            <p class="text-gray-600 dark:text-gray-400 mb-6">Please refer to the table below for current billing and receipt printing.</p>

            <div class="card-gradient dark:bg-slate-800/50 p-4 md:p-6 rounded-2xl shadow-inner dark:shadow-none dark:border dark:border-dark-border/30">
    ...
    <div id="dashboardSection" class="dashboard-section">
        ...
        <div class="sticky top-0 z-20 bg-slate-50/95 backdrop-blur-md py-3 sm:py-4 border-b border-gray-200 mb-6 flex flex-row items-center justify-center sm:justify-between gap-4 shadow-sm sm:shadow-none">
            <div class="text-center sm:text-left">
                <h2 class="text-xl sm:text-3xl font-bold text-gray-800 leading-tight">Market Insights</h2>
                <p class="text-xs sm:text-sm text-gray-500 hidden sm:block mt-1">Overview of market operations for the year <span id="selectedYearDisplay"
                        class="font-semibold">{{ date('Y') }}</span>.</p>
            </div>
            <div class="flex-shrink-0">
                <select id="dashboardYearFilter"
                    class="bg-white text-sm sm:text-base border border-gray-300 rounded-lg px-3 py-1.5 sm:px-4 sm:py-2 focus:outline-none focus:ring-2 focus:ring-market-primary shadow-sm cursor-pointer">
