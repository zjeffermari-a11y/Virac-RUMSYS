                ...
                <table class="min-w-full responsive-table">
                    <thead id="notificationTableHeader">
                        <tr class="table-header">
                            ...
                            <th class="px-6 py-4 text-left text-sm font-medium uppercase tracking-wider">Date of Approval/Rejection</th>
                        </tr>
                    </thead>
                    ...
                    <div class="relative inline-block">
                        <div id="profilePictureContainer" class="w-32 h-32 rounded-full overflow-hidden bg-gray-200 mx-auto mb-4 border-4 border-market-primary shadow-lg">
                            @if(auth()->user()->profile_picture)
                                <img id="profilePictureImg" src="{{ auth()->user()->profile_picture_url ?? Storage::url(auth()->user()->profile_picture) }}" 
