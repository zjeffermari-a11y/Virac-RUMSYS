...
@section('navigation')
    <a href="#dashboardSection" data-section="dashboardSection"
        class="nav-link active text-white/70 font-medium rounded-xl p-3 mb-3 hover:bg-white/8 cursor-pointer transition-smooth flex items-center space-x-3">
    ...
    <a href="#notificationSection" data-section="notificationSection"
        class="nav-link text-white/70 font-medium rounded-xl p-3 mb-3 hover:bg-white/8 cursor-pointer transition-smooth flex items-center space-x-3">
...
@section('content')
    ...
    <div id="dashboardSection" class="dashboard-section overflow-visible">
        ...
        <div class="sticky top-0 z-20 bg-slate-50/95 dark:bg-dark-bg/95 backdrop-blur-md py-3 sm:py-4 border-b border-gray-200 dark:border-dark-border/30 mb-6 flex flex-row items-center justify-center sm:justify-between gap-4 shadow-sm sm:shadow-none">
            <div class="text-center sm:text-left">
                <h2 class="text-xl sm:text-3xl font-bold text-gray-800 dark:text-dark-muted leading-tight">Market Insights</h2>
                <p class="text-xs sm:text-sm text-gray-500 dark:text-dark-border hidden sm:block mt-1">Overview of market operations for the year <span id="selectedYearDisplay"
                        class="font-semibold dark:text-dark-accent">{{ date('Y') }}</span>.</p>
            </div>
            <div class="flex-shrink-0">
                <select id="dashboardYearFilter"
                    class="bg-white dark:bg-dark-surface dark:text-dark-muted dark:border-dark-border/50 text-sm sm:text-base border border-gray-300 rounded-lg px-3 py-1.5 sm:px-4 sm:py-2 focus:outline-none focus:ring-2 focus:ring-market-primary shadow-sm cursor-pointer">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
            <div class="lg:col-span-2 bg-white dark:bg-dark-surface p-6 rounded-2xl shadow-lg dark:shadow-none border border-transparent dark:border-dark-border/30">
                <h3 class="text-lg font-semibold text-gray-700 dark:text-dark-muted mb-4">Vendor Distribution by Section</h3>
                <div class="h-80 flex items-center justify-center">
                    <canvas id="vendorDistributionChart"></canvas>
                </div>
            </div>
            <div class="lg:col-span-3 bg-white dark:bg-dark-surface p-6 rounded-2xl shadow-lg dark:shadow-none border border-transparent dark:border-dark-border/30">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-semibold text-gray-700 dark:text-dark-muted">Monthly Collection Trends</h3>
                    <select id="collectionTypeFilter"
                        class="text-sm bg-gray-50 dark:bg-dark-bg dark:text-dark-muted border border-gray-300 dark:border-dark-border/50 rounded-lg px-3 py-1 focus:outline-none">
            ...
            <div class="lg:col-span-5 bg-white dark:bg-dark-surface p-6 rounded-2xl shadow-lg dark:shadow-none border border-transparent dark:border-dark-border/30">
                <h3 class="text-lg font-semibold text-gray-700 dark:text-dark-muted mb-4">Monthly Electricity Consumption</h3>
                <div class="h-80">
        ...
        <div class="mt-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="bg-white dark:bg-dark-surface p-6 rounded-2xl shadow-lg dark:shadow-none border border-transparent dark:border-dark-border/30">
                    <div class="flex justify-between items-center mb-4">
                        <h4 class="text-lg font-semibold text-gray-700 dark:text-dark-muted flex items-center">
                            <i class="fas fa-trophy text-dark-accent mr-3"></i> Top Vendors (On-Time Payments)
                        </h4>
                ...
                <div class="bg-white dark:bg-dark-surface p-6 rounded-2xl shadow-lg dark:shadow-none border border-transparent dark:border-dark-border/30">
                    <div class="flex justify-between items-center mb-4">
                        <h4 class="text-lg font-semibold text-gray-700 dark:text-dark-muted flex items-center">
                            <i class="fas fa-hands-helping text-blue-400 mr-3"></i> Vendors Needing Support
                        </h4>
