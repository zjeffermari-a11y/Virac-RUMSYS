...
INSERT INTO `sms_notification_settings` (`id`, `name`, `message_template`, `enabled`, `created_at`, `updated_at`) VALUES
	(1, 'bill_statement_wet_section', 'Paisi tabi na ang bayadan mo para sa renta nagkakahalaga ning â‚±{{rent_amount}}, asin para sa tubig - â‚±{{water_amount}}, siring naman pati ang bayadan sa kuryente na - â‚±{{electricity_amount}}. Total due: â‚±{{total_due}} sa petsa ning {{due_date}}.', 1, '2025-08-28 09:33:07', '2025-09-04 21:08:37'),
	(2, 'bill_statement_dry_section', 'Your bill statement: Rent - â‚±{{rent_amount}}, Water - â‚±{{water_amount}}. Total due: â‚±{{total_due}} sa petsa ning {{due_date}}. Thank you {{ vendor_name }} with {{ stall_number }} Stall/Table Number', 1, '2025-08-28 09:33:07', '2025-09-04 21:08:37'),
	...
	(4, 'overdue_alert_template', 'OVERDUE: Your payment for {{overdue_items}} is past due. Your new total with penalties is â‚±{{new_total_due}}. Disconnection is on {{disconnection_date}}. Thank you {{vendor_name}} HAHA', 1, '2025-08-28 09:33:07', '2025-09-04 21:08:37');
