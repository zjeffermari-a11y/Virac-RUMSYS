...
class ScheduleController extends Controller
{
    ...
    public function updateBillingDates(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'schedules.*.type' => 'required|string|in:Due Date - Electricity,Disconnection - Electricity,Due Date - Water,Disconnection - Water,Due Date - Rent,Disconnection - Rent',
    ...
    public function updateSmsSchedules(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'schedules' => 'required|array|min:1',
            'schedules.*.type' => 'required|string|in:SMS - Billing Statements,SMS - Payment Reminders,SMS - Overdue Alerts',
