...
class ForgotPasswordController extends Controller
{
    ...
    public function sendResetSms(Request $request)
    {
        ...
        if (!$vendor || !$vendor->getSemaphoreReadyContactNumber()) {
            // Use a generic message to prevent username enumeration
            return back()->with('status', 'If this username is registered, a temporary password will be sent to the contact number on file.');
        }
